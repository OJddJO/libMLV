...
MLVAPI void MLV_wait_keyboard(MLV_Keyboard_button *sym, MLV_Keyboard_modifier *mod, int *unicode) {
    ...
    while (
        (MLV_wait_event(sym, mod, unicode, NULL, NULL, NULL, NULL, NULL, &state) != MLV_KEY) || (state != MLV_PRESSED))
        ;
}
...
MLVAPI MLV_Event MLV_wait_keyboard_or_milliseconds(MLV_Keyboard_button *sym, MLV_Keyboard_modifier *mod, int *unicode,
    ...
    // We wait for a new keyboard event
    while ((((resultat = MLV_wait_event_or_milliseconds(&tmp_sym, &tmp_mod, &tmp_unicode, NULL, NULL, NULL, NULL, NULL,
                  &state, milliseconds - (MLV_get_time() - time))) != MLV_KEY) ||
               (state != MLV_PRESSED)) &&
...
MLVAPI MLV_Keyboard_button MLV_convert_string_to_keyboard_button(const char *key_string) {
    ...
    if (strcmp(key_string, "MLV_KEYBOARD_BACKSPACE") == 0) { return MLV_KEYBOARD_BACKSPACE; }
    if (strcmp(key_string, "MLV_KEYBOARD_TAB") == 0) { return MLV_KEYBOARD_TAB; }
    if (strcmp(key_string, "MLV_KEYBOARD_CLEAR") == 0) { return MLV_KEYBOARD_CLEAR; }
    if (strcmp(key_string, "MLV_KEYBOARD_RETURN") == 0) { return MLV_KEYBOARD_RETURN; }
    if (strcmp(key_string, "MLV_KEYBOARD_PAUSE") == 0) { return MLV_KEYBOARD_PAUSE; }
    if (strcmp(key_string, "MLV_KEYBOARD_ESCAPE") == 0) { return MLV_KEYBOARD_ESCAPE; }
    if (strcmp(key_string, "MLV_KEYBOARD_SPACE") == 0) { return MLV_KEYBOARD_SPACE; }
    if (strcmp(key_string, "MLV_KEYBOARD_EXCLAIM") == 0) { return MLV_KEYBOARD_EXCLAIM; }
    if (strcmp(key_string, "MLV_KEYBOARD_QUOTEDBL") == 0) { return MLV_KEYBOARD_QUOTEDBL; }
    if (strcmp(key_string, "MLV_KEYBOARD_HASH") == 0) { return MLV_KEYBOARD_HASH; }
    if (strcmp(key_string, "MLV_KEYBOARD_DOLLAR") == 0) { return MLV_KEYBOARD_DOLLAR; }
    if (strcmp(key_string, "MLV_KEYBOARD_AMPERSAND") == 0) { return MLV_KEYBOARD_AMPERSAND; }
    if (strcmp(key_string, "MLV_KEYBOARD_QUOTE") == 0) { return MLV_KEYBOARD_QUOTE; }
    if (strcmp(key_string, "MLV_KEYBOARD_LEFTPAREN") == 0) { return MLV_KEYBOARD_LEFTPAREN; }
    if (strcmp(key_string, "MLV_KEYBOARD_RIGHTPAREN") == 0) { return MLV_KEYBOARD_RIGHTPAREN; }
    if (strcmp(key_string, "MLV_KEYBOARD_ASTERISK") == 0) { return MLV_KEYBOARD_ASTERISK; }
    if (strcmp(key_string, "MLV_KEYBOARD_PLUS") == 0) { return MLV_KEYBOARD_PLUS; }
    if (strcmp(key_string, "MLV_KEYBOARD_COMMA") == 0) { return MLV_KEYBOARD_COMMA; }
    if (strcmp(key_string, "MLV_KEYBOARD_MINUS") == 0) { return MLV_KEYBOARD_MINUS; }
    if (strcmp(key_string, "MLV_KEYBOARD_PERIOD") == 0) { return MLV_KEYBOARD_PERIOD; }
    if (strcmp(key_string, "MLV_KEYBOARD_SLASH") == 0) { return MLV_KEYBOARD_SLASH; }
    if (strcmp(key_string, "MLV_KEYBOARD_0") == 0) { return MLV_KEYBOARD_0; }
    if (strcmp(key_string, "MLV_KEYBOARD_1") == 0) { return MLV_KEYBOARD_1; }
    if (strcmp(key_string, "MLV_KEYBOARD_2") == 0) { return MLV_KEYBOARD_2; }
    if (strcmp(key_string, "MLV_KEYBOARD_3") == 0) { return MLV_KEYBOARD_3; }
    if (strcmp(key_string, "MLV_KEYBOARD_4") == 0) { return MLV_KEYBOARD_4; }
    if (strcmp(key_string, "MLV_KEYBOARD_5") == 0) { return MLV_KEYBOARD_5; }
    if (strcmp(key_string, "MLV_KEYBOARD_6") == 0) { return MLV_KEYBOARD_6; }
    if (strcmp(key_string, "MLV_KEYBOARD_7") == 0) { return MLV_KEYBOARD_7; }
    if (strcmp(key_string, "MLV_KEYBOARD_8") == 0) { return MLV_KEYBOARD_8; }
    if (strcmp(key_string, "MLV_KEYBOARD_9") == 0) { return MLV_KEYBOARD_9; }
    if (strcmp(key_string, "MLV_KEYBOARD_COLON") == 0) { return MLV_KEYBOARD_COLON; }
    if (strcmp(key_string, "MLV_KEYBOARD_SEMICOLON") == 0) { return MLV_KEYBOARD_SEMICOLON; }
    if (strcmp(key_string, "MLV_KEYBOARD_LESS") == 0) { return MLV_KEYBOARD_LESS; }
    if (strcmp(key_string, "MLV_KEYBOARD_EQUALS") == 0) { return MLV_KEYBOARD_EQUALS; }
    if (strcmp(key_string, "MLV_KEYBOARD_GREATER") == 0) { return MLV_KEYBOARD_GREATER; }
    if (strcmp(key_string, "MLV_KEYBOARD_QUESTION") == 0) { return MLV_KEYBOARD_QUESTION; }
    if (strcmp(key_string, "MLV_KEYBOARD_AT") == 0) { return MLV_KEYBOARD_AT; }
    if (strcmp(key_string, "MLV_KEYBOARD_LEFTBRACKET") == 0) { return MLV_KEYBOARD_LEFTBRACKET; }
    if (strcmp(key_string, "MLV_KEYBOARD_BACKSLASH") == 0) { return MLV_KEYBOARD_BACKSLASH; }
    if (strcmp(key_string, "MLV_KEYBOARD_RIGHTBRACKET") == 0) { return MLV_KEYBOARD_RIGHTBRACKET; }
    if (strcmp(key_string, "MLV_KEYBOARD_CARET") == 0) { return MLV_KEYBOARD_CARET; }
    if (strcmp(key_string, "MLV_KEYBOARD_UNDERSCORE") == 0) { return MLV_KEYBOARD_UNDERSCORE; }
    if (strcmp(key_string, "MLV_KEYBOARD_BACKQUOTE") == 0) { return MLV_KEYBOARD_BACKQUOTE; }
    if (strcmp(key_string, "MLV_KEYBOARD_a") == 0) { return MLV_KEYBOARD_a; }
    if (strcmp(key_string, "MLV_KEYBOARD_b") == 0) { return MLV_KEYBOARD_b; }
    if (strcmp(key_string, "MLV_KEYBOARD_c") == 0) { return MLV_KEYBOARD_c; }
    if (strcmp(key_string, "MLV_KEYBOARD_d") == 0) { return MLV_KEYBOARD_d; }
    if (strcmp(key_string, "MLV_KEYBOARD_e") == 0) { return MLV_KEYBOARD_e; }
    if (strcmp(key_string, "MLV_KEYBOARD_f") == 0) { return MLV_KEYBOARD_f; }
    if (strcmp(key_string, "MLV_KEYBOARD_g") == 0) { return MLV_KEYBOARD_g; }
    if (strcmp(key_string, "MLV_KEYBOARD_h") == 0) { return MLV_KEYBOARD_h; }
    if (strcmp(key_string, "MLV_KEYBOARD_i") == 0) { return MLV_KEYBOARD_i; }
    if (strcmp(key_string, "MLV_KEYBOARD_j") == 0) { return MLV_KEYBOARD_j; }
    if (strcmp(key_string, "MLV_KEYBOARD_k") == 0) { return MLV_KEYBOARD_k; }
    if (strcmp(key_string, "MLV_KEYBOARD_l") == 0) { return MLV_KEYBOARD_l; }
    if (strcmp(key_string, "MLV_KEYBOARD_m") == 0) { return MLV_KEYBOARD_m; }
    if (strcmp(key_string, "MLV_KEYBOARD_n") == 0) { return MLV_KEYBOARD_n; }
    if (strcmp(key_string, "MLV_KEYBOARD_o") == 0) { return MLV_KEYBOARD_o; }
    if (strcmp(key_string, "MLV_KEYBOARD_p") == 0) { return MLV_KEYBOARD_p; }
    if (strcmp(key_string, "MLV_KEYBOARD_q") == 0) { return MLV_KEYBOARD_q; }
    if (strcmp(key_string, "MLV_KEYBOARD_r") == 0) { return MLV_KEYBOARD_r; }
    if (strcmp(key_string, "MLV_KEYBOARD_s") == 0) { return MLV_KEYBOARD_s; }
    if (strcmp(key_string, "MLV_KEYBOARD_t") == 0) { return MLV_KEYBOARD_t; }
    if (strcmp(key_string, "MLV_KEYBOARD_u") == 0) { return MLV_KEYBOARD_u; }
    if (strcmp(key_string, "MLV_KEYBOARD_v") == 0) { return MLV_KEYBOARD_v; }
    if (strcmp(key_string, "MLV_KEYBOARD_w") == 0) { return MLV_KEYBOARD_w; }
    if (strcmp(key_string, "MLV_KEYBOARD_x") == 0) { return MLV_KEYBOARD_x; }
    if (strcmp(key_string, "MLV_KEYBOARD_y") == 0) { return MLV_KEYBOARD_y; }
    if (strcmp(key_string, "MLV_KEYBOARD_z") == 0) { return MLV_KEYBOARD_z; }
    if (strcmp(key_string, "MLV_KEYBOARD_DELETE") == 0) { return MLV_KEYBOARD_DELETE; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_0") == 0) { return MLV_KEYBOARD_WORLD_0; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_1") == 0) { return MLV_KEYBOARD_WORLD_1; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_2") == 0) { return MLV_KEYBOARD_WORLD_2; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_3") == 0) { return MLV_KEYBOARD_WORLD_3; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_4") == 0) { return MLV_KEYBOARD_WORLD_4; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_5") == 0) { return MLV_KEYBOARD_WORLD_5; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_6") == 0) { return MLV_KEYBOARD_WORLD_6; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_7") == 0) { return MLV_KEYBOARD_WORLD_7; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_8") == 0) { return MLV_KEYBOARD_WORLD_8; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_9") == 0) { return MLV_KEYBOARD_WORLD_9; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_10") == 0) { return MLV_KEYBOARD_WORLD_10; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_11") == 0) { return MLV_KEYBOARD_WORLD_11; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_12") == 0) { return MLV_KEYBOARD_WORLD_12; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_13") == 0) { return MLV_KEYBOARD_WORLD_13; }
    ...
    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_17") == 0) { return MLV_KEYBOARD_WORLD_17; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_18") == 0) { return MLV_KEYBOARD_WORLD_18; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_19") == 0) { return MLV_KEYBOARD_WORLD_19; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_20") == 0) { return MLV_KEYBOARD_WORLD_20; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_21") == 0) { return MLV_KEYBOARD_WORLD_21; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_22") == 0) { return MLV_KEYBOARD_WORLD_22; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_23") == 0) { return MLV_KEYBOARD_WORLD_23; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_24") == 0) { return MLV_KEYBOARD_WORLD_24; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_25") == 0) { return MLV_KEYBOARD_WORLD_25; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_26") == 0) { return MLV_KEYBOARD_WORLD_26; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_27") == 0) { return MLV_KEYBOARD_WORLD_27; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_28") == 0) { return MLV_KEYBOARD_WORLD_28; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_29") == 0) { return MLV_KEYBOARD_WORLD_29; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_30") == 0) { return MLV_KEYBOARD_WORLD_30; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_31") == 0) { return MLV_KEYBOARD_WORLD_31; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_32") == 0) { return MLV_KEYBOARD_WORLD_32; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_33") == 0) { return MLV_KEYBOARD_WORLD_33; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_34") == 0) { return MLV_KEYBOARD_WORLD_34; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_35") == 0) { return MLV_KEYBOARD_WORLD_35; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_36") == 0) { return MLV_KEYBOARD_WORLD_36; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_37") == 0) { return MLV_KEYBOARD_WORLD_37; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_38") == 0) { return MLV_KEYBOARD_WORLD_38; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_39") == 0) { return MLV_KEYBOARD_WORLD_39; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_40") == 0) { return MLV_KEYBOARD_WORLD_40; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_41") == 0) { return MLV_KEYBOARD_WORLD_41; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_42") == 0) { return MLV_KEYBOARD_WORLD_42; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_43") == 0) { return MLV_KEYBOARD_WORLD_43; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_44") == 0) { return MLV_KEYBOARD_WORLD_44; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_45") == 0) { return MLV_KEYBOARD_WORLD_45; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_46") == 0) { return MLV_KEYBOARD_WORLD_46; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_47") == 0) { return MLV_KEYBOARD_WORLD_47; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_48") == 0) { return MLV_KEYBOARD_WORLD_48; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_49") == 0) { return MLV_KEYBOARD_WORLD_49; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_50") == 0) { return MLV_KEYBOARD_WORLD_50; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_51") == 0) { return MLV_KEYBOARD_WORLD_51; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_52") == 0) { return MLV_KEYBOARD_WORLD_52; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_53") == 0) { return MLV_KEYBOARD_WORLD_53; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_54") == 0) { return MLV_KEYBOARD_WORLD_54; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_55") == 0) { return MLV_KEYBOARD_WORLD_55; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_56") == 0) { return MLV_KEYBOARD_WORLD_56; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_57") == 0) { return MLV_KEYBOARD_WORLD_57; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_58") == 0) { return MLV_KEYBOARD_WORLD_58; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_59") == 0) { return MLV_KEYBOARD_WORLD_59; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_60") == 0) { return MLV_KEYBOARD_WORLD_60; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_61") == 0) { return MLV_KEYBOARD_WORLD_61; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_62") == 0) { return MLV_KEYBOARD_WORLD_62; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_63") == 0) { return MLV_KEYBOARD_WORLD_63; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_64") == 0) { return MLV_KEYBOARD_WORLD_64; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_65") == 0) { return MLV_KEYBOARD_WORLD_65; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_66") == 0) { return MLV_KEYBOARD_WORLD_66; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_67") == 0) { return MLV_KEYBOARD_WORLD_67; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_68") == 0) { return MLV_KEYBOARD_WORLD_68; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_69") == 0) { return MLV_KEYBOARD_WORLD_69; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_70") == 0) { return MLV_KEYBOARD_WORLD_70; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_71") == 0) { return MLV_KEYBOARD_WORLD_71; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_72") == 0) { return MLV_KEYBOARD_WORLD_72; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_73") == 0) { return MLV_KEYBOARD_WORLD_73; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_74") == 0) { return MLV_KEYBOARD_WORLD_74; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_75") == 0) { return MLV_KEYBOARD_WORLD_75; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_76") == 0) { return MLV_KEYBOARD_WORLD_76; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_77") == 0) { return MLV_KEYBOARD_WORLD_77; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_78") == 0) { return MLV_KEYBOARD_WORLD_78; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_79") == 0) { return MLV_KEYBOARD_WORLD_79; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_80") == 0) { return MLV_KEYBOARD_WORLD_80; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_81") == 0) { return MLV_KEYBOARD_WORLD_81; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_82") == 0) { return MLV_KEYBOARD_WORLD_82; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_83") == 0) { return MLV_KEYBOARD_WORLD_83; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_84") == 0) { return MLV_KEYBOARD_WORLD_84; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_85") == 0) { return MLV_KEYBOARD_WORLD_85; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_86") == 0) { return MLV_KEYBOARD_WORLD_86; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_87") == 0) { return MLV_KEYBOARD_WORLD_87; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_88") == 0) { return MLV_KEYBOARD_WORLD_88; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_89") == 0) { return MLV_KEYBOARD_WORLD_89; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_90") == 0) { return MLV_KEYBOARD_WORLD_90; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_91") == 0) { return MLV_KEYBOARD_WORLD_91; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_92") == 0) { return MLV_KEYBOARD_WORLD_92; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_93") == 0) { return MLV_KEYBOARD_WORLD_93; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_94") == 0) { return MLV_KEYBOARD_WORLD_94; }

    if (strcmp(key_string, "MLV_KEYBOARD_WORLD_95") == 0) { return MLV_KEYBOARD_WORLD_95; }

    if (strcmp(key_string, "MLV_KEYBOARD_KP0") == 0) { return MLV_KEYBOARD_KP0; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP1") == 0) { return MLV_KEYBOARD_KP1; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP2") == 0) { return MLV_KEYBOARD_KP2; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP3") == 0) { return MLV_KEYBOARD_KP3; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP4") == 0) { return MLV_KEYBOARD_KP4; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP5") == 0) { return MLV_KEYBOARD_KP5; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP6") == 0) { return MLV_KEYBOARD_KP6; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP7") == 0) { return MLV_KEYBOARD_KP7; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP8") == 0) { return MLV_KEYBOARD_KP8; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP9") == 0) { return MLV_KEYBOARD_KP9; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_PERIOD") == 0) { return MLV_KEYBOARD_KP_PERIOD; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_DIVIDE") == 0) { return MLV_KEYBOARD_KP_DIVIDE; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_MULTIPLY") == 0) { return MLV_KEYBOARD_KP_MULTIPLY; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_MINUS") == 0) { return MLV_KEYBOARD_KP_MINUS; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_PLUS") == 0) { return MLV_KEYBOARD_KP_PLUS; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_ENTER") == 0) { return MLV_KEYBOARD_KP_ENTER; }
    if (strcmp(key_string, "MLV_KEYBOARD_KP_EQUALS") == 0) { return MLV_KEYBOARD_KP_EQUALS; }
    if (strcmp(key_string, "MLV_KEYBOARD_UP") == 0) { return MLV_KEYBOARD_UP; }
    if (strcmp(key_string, "MLV_KEYBOARD_DOWN") == 0) { return MLV_KEYBOARD_DOWN; }
    if (strcmp(key_string, "MLV_KEYBOARD_RIGHT") == 0) { return MLV_KEYBOARD_RIGHT; }
    if (strcmp(key_string, "MLV_KEYBOARD_LEFT") == 0) { return MLV_KEYBOARD_LEFT; }
    if (strcmp(key_string, "MLV_KEYBOARD_INSERT") == 0) { return MLV_KEYBOARD_INSERT; }
    if (strcmp(key_string, "MLV_KEYBOARD_HOME") == 0) { return MLV_KEYBOARD_HOME; }
    if (strcmp(key_string, "MLV_KEYBOARD_END") == 0) { return MLV_KEYBOARD_END; }
    if (strcmp(key_string, "MLV_KEYBOARD_PAGEUP") == 0) { return MLV_KEYBOARD_PAGEUP; }
    if (strcmp(key_string, "MLV_KEYBOARD_PAGEDOWN") == 0) { return MLV_KEYBOARD_PAGEDOWN; }
    if (strcmp(key_string, "MLV_KEYBOARD_F1") == 0) { return MLV_KEYBOARD_F1; }
    if (strcmp(key_string, "MLV_KEYBOARD_F2") == 0) { return MLV_KEYBOARD_F2; }
    if (strcmp(key_string, "MLV_KEYBOARD_F3") == 0) { return MLV_KEYBOARD_F3; }
    if (strcmp(key_string, "MLV_KEYBOARD_F4") == 0) { return MLV_KEYBOARD_F4; }
    if (strcmp(key_string, "MLV_KEYBOARD_F5") == 0) { return MLV_KEYBOARD_F5; }
    if (strcmp(key_string, "MLV_KEYBOARD_F6") == 0) { return MLV_KEYBOARD_F6; }
    if (strcmp(key_string, "MLV_KEYBOARD_F7") == 0) { return MLV_KEYBOARD_F7; }
    if (strcmp(key_string, "MLV_KEYBOARD_F8") == 0) { return MLV_KEYBOARD_F8; }
    if (strcmp(key_string, "MLV_KEYBOARD_F9") == 0) { return MLV_KEYBOARD_F9; }
    if (strcmp(key_string, "MLV_KEYBOARD_F10") == 0) { return MLV_KEYBOARD_F10; }
    if (strcmp(key_string, "MLV_KEYBOARD_F11") == 0) { return MLV_KEYBOARD_F11; }
    if (strcmp(key_string, "MLV_KEYBOARD_F12") == 0) { return MLV_KEYBOARD_F12; }
    if (strcmp(key_string, "MLV_KEYBOARD_F13") == 0) { return MLV_KEYBOARD_F13; }
    if (strcmp(key_string, "MLV_KEYBOARD_F14") == 0) { return MLV_KEYBOARD_F14; }
    if (strcmp(key_string, "MLV_KEYBOARD_F15") == 0) { return MLV_KEYBOARD_F15; }
    if (strcmp(key_string, "MLV_KEYBOARD_NUMLOCK") == 0) { return MLV_KEYBOARD_NUMLOCK; }
    if (strcmp(key_string, "MLV_KEYBOARD_CAPSLOCK") == 0) { return MLV_KEYBOARD_CAPSLOCK; }
    if (strcmp(key_string, "MLV_KEYBOARD_SCROLLOCK") == 0) { return MLV_KEYBOARD_SCROLLOCK; }
    if (strcmp(key_string, "MLV_KEYBOARD_RSHIFT") == 0) { return MLV_KEYBOARD_RSHIFT; }
    if (strcmp(key_string, "MLV_KEYBOARD_LSHIFT") == 0) { return MLV_KEYBOARD_LSHIFT; }
    if (strcmp(key_string, "MLV_KEYBOARD_RCTRL") == 0) { return MLV_KEYBOARD_RCTRL; }
    if (strcmp(key_string, "MLV_KEYBOARD_LCTRL") == 0) { return MLV_KEYBOARD_LCTRL; }
    if (strcmp(key_string, "MLV_KEYBOARD_RALT") == 0) { return MLV_KEYBOARD_RALT; }
    if (strcmp(key_string, "MLV_KEYBOARD_LALT") == 0) { return MLV_KEYBOARD_LALT; }
    if (strcmp(key_string, "MLV_KEYBOARD_RMETA") == 0) { return MLV_KEYBOARD_RMETA; }
    if (strcmp(key_string, "MLV_KEYBOARD_LMETA") == 0) { return MLV_KEYBOARD_LMETA; }
    if (strcmp(key_string, "MLV_KEYBOARD_LSUPER") == 0) { return MLV_KEYBOARD_LSUPER; }
    if (strcmp(key_string, "MLV_KEYBOARD_RSUPER") == 0) { return MLV_KEYBOARD_RSUPER; }
    if (strcmp(key_string, "MLV_KEYBOARD_MODE") == 0) { return MLV_KEYBOARD_MODE; }
    if (strcmp(key_string, "MLV_KEYBOARD_COMPOSE") == 0) { return MLV_KEYBOARD_COMPOSE; }
    if (strcmp(key_string, "MLV_KEYBOARD_HELP") == 0) { return MLV_KEYBOARD_HELP; }
    if (strcmp(key_string, "MLV_KEYBOARD_PRINT") == 0) { return MLV_KEYBOARD_PRINT; }
    if (strcmp(key_string, "MLV_KEYBOARD_SYSREQ") == 0) { return MLV_KEYBOARD_SYSREQ; }
    if (strcmp(key_string, "MLV_KEYBOARD_BREAK") == 0) { return MLV_KEYBOARD_BREAK; }
    if (strcmp(key_string, "MLV_KEYBOARD_MENU") == 0) { return MLV_KEYBOARD_MENU; }
    if (strcmp(key_string, "MLV_KEYBOARD_POWER") == 0) { return MLV_KEYBOARD_POWER; }
    if (strcmp(key_string, "MLV_KEYBOARD_EURO") == 0) { return MLV_KEYBOARD_EURO; }
    if (strcmp(key_string, "MLV_KEYBOARD_UNDO") == 0) { return MLV_KEYBOARD_UNDO; }
    if (strcmp(key_string, "MLV_KEYBOARD_LAST") == 0) { return MLV_KEYBOARD_LAST; }
